...
saveRDS(result_new, "Chapter3/Results/SettingI/result_new.RDS")
saveRDS(result_new_viral, "Chapter3/Results/SettingI/result_new_viral.RDS")
saveRDS(result_naive, "Chapter3/Results/SettingI/result_naive.RDS")
saveRDS(result_empirical, "Chapter3/Results/SettingI/result_empirical.RDS")

result_new <- readRDS("Chapter3/Results/SettingI/result_new.RDS")
result_new_viral <- readRDS("Chapter3/Results/SettingI/result_new_viral.RDS")
result_naive <- readRDS("Chapter3/Results/SettingI/result_naive.RDS")
result_empirical <- readRDS("Chapter3/Results/SettingI/result_empirical.RDS")

table_names <- c("Method", "Parameter","True Value", "Estimates","SE", "Bias (%)","rMSE (%)", "Coverage")
...
table$Method <- c("NLME",rep(NA,6), rep(c("NLME","LME","Naive"), 2))
table$Estimates <- c(result_new_viral[2,], rbind(result_new[2,], result_naive[2,], result_empirical[2,]))
table$`SE` <- c(result_new_viral[5,], rbind(result_new[5,], result_naive[4,], result_empirical[4,]))
...
latex_table<-xtable(table, type = "latex",align=c("ccccccccc"))
digits(latex_table)<-c(0,0,2,3,3,3,3,3,2)
print(latex_table, file = "Chapter3/Results/SettingI/latex_table.tex",include.rownames=FALSE,sanitize.text.function = function(x){x},hline.after = c(-1,0,7))
